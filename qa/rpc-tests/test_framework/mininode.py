...
import logging
import copy
import universalmonetaryprotocol_scrypt
...
class CBlockHeader(object):
    ...
    def calc_sha256(self):
        if self.sha256 is None:
            ...
            self.scrypt256 = uint256_from_str(universalmonetaryprotocol_scrypt.getPoWHash(r))
...
class NodeConn(asyncore.dispatcher):
    ...
    def __init__(self, dstaddr, dstport, rpc, callback, net="regtest", services=NODE_NETWORK, send_version=True):
        ...
        print('MiniNode: Connecting to UniversalMonetaryProtocol Node IP # ' + dstaddr + ':' \
            + str(dstport))
