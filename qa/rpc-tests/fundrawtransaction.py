...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid universalmonetaryprotocol address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid universalmonetaryprotocol address" in e.error['message'])
