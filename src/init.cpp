...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/universalmonetaryprotocol-project/universalmonetaryprotocol>";
    const std::string URL_WEBSITE = "<https://universalmonetaryprotocol.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("UniversalMonetaryProtocol version %s\n", FormatFullVersion());
}
