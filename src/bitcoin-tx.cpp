...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s universalmonetaryprotocol-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  universalmonetaryprotocol-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded universalmonetaryprotocol transaction") + "\n" +
              "  universalmonetaryprotocol-tx [options] -create [commands]   " + _("Create hex-encoded universalmonetaryprotocol transaction") + "\n" +
              "\n";
